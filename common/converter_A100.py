...
def parse_args():
    ...
    # Cityflow1x1(Config 1)
    # parser.add_argument("--or_cityflownet", type=str,
    #                     default='hangzhou_1x1_bc-tyc_18041610_1h/roadnet.json')
    # parser.add_argument("--sumonet", type=str,
    #                     default='hangzhou_1x1_bc-tyc_18041610_1h/hangzhou_1x1_bc-tyc_18041610_1h_test.net.xml')
    # parser.add_argument("--or_cityflowflow", type=str,
    #                     default='hangzhou_1x1_bc-tyc_18041610_1h/flow.json')
    # parser.add_argument("--sumoflow", type=str,
    #                     default='hangzhou_1x1_bc-tyc_18041610_1h/hangzhou_1x1_bc-tyc_18041610_1h_test.rou.xml')
    
    # Cityflow1x1(Config 2)
    # parser.add_argument("--or_cityflownet", type=str,
    ...
    # parser.add_argument("--or_cityflownet", type=str,
    #                     default='hangzhou_1x1_sb-sx_18041607_1h/roadnet.json')
    # parser.add_argument("--sumonet", type=str,
    #                     default='hangzhou_1x1_sb-sx_18041607_1h/hangzhou_1x1_sb-sx_18041607_1h.net.xml')
    # parser.add_argument("--or_cityflowflow", type=str,
    #                     default='hangzhou_1x1_sb-sx_18041607_1h/flow.json')
    # parser.add_argument("--sumoflow", type=str,
...
def cityflow2sumo_net(args):
    ...
    for inter in data['intersections']:
        ...
        if not inter['virtual']:
            lane_num = len(set([i['type'] for i in inter['roadLinks']]))
