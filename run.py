...
# parser.add_argument('--path', type=str, default='configs/cityflow_grid4x4.cfg', help='path to cityflow path')
parser.add_argument('--path', type=str, default='configs/sumo4x4.cfg', help='path to cityflow path')
