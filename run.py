...
parser.add_argument('-t', '--task', type=str, default="tscfx", help="task type to run")
parser.add_argument('-a', '--agent', type=str, default="maddpg_marl", help="agent type of agents in RL environment")
parser.add_argument('-w', '--world', type=str, default="sumo", choices=['cityflow','sumo'], help="simulator type")
parser.add_argument('-n', '--network', type=str, default="sumo1x3", help="network name")
