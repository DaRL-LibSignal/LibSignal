...
parser.add_argument('--prefix', type=str, default='state-lp', help="the number of prefix in this running process")
...
parser.add_argument('-n', '--network', type=str, default="cityflow_cologne3", help="network name")
