...
file_prefix = args.prefix +"_"+"Colight_"+ str(args.graph_info_dir)+ "_" +str(args.learning_rate) + "_" + str(args.epsilon) + "_" + str(args.epsilon_decay) + "_" +str(args.batch_size) + "_" + str(args.learning_start) + "_" + str(args.replay_buffer_size) + "_" +datetime.now().strftime('%Y%m%d-%H%M%S')
