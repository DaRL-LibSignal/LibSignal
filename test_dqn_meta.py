...
parser.add_argument('--save_dir', type=str, default="model/meta_dqn_4x4/",
                    help='directory in which model should be saved')
parser.add_argument('--log_dir', type=str, default="log/meta_dqn_4x4/",
...
def test(path, c, q):
    ...
    for agent in agents:
        agent.load_model(args.save_dir, 19)
